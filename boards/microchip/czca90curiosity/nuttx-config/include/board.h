...
/* SERCOM4 – RC Input UART (PC21 PAD0 TX / PC22 PAD1 RX, function D)
 *   EXT2 header pins 13/14 — PX4 port 101 = /dev/ttyS2
 *   ATDF-verified: PC21/PC22 mux D = SERCOM4 PAD0/PAD1
 *   TEMPORARY: reconfigured for SBUS RC testing (RadioMaster TX16S + R81)
 *   Core clock: GCLK2 = 100 MHz
 *   RXINV set — SBUS is inverted serial at 100000 baud 8E2
 *   TO RESTORE TELEMETRY: remove USART_CTRLA_RXINV, set defconfig USART4_BAUD=57600
 *                          USART4_PARITY=0 USART4_2STOP=0
 *                          params: MAV_0_CONFIG=101, RC_PORT_CONFIG=300
 */

#define BOARD_SERCOM4_MUXCONFIG   (USART_CTRLA_TXPO_PAD0 | USART_CTRLA_RXPAD1 | USART_CTRLA_RXINV)
#define BOARD_SERCOM4_PINMAP_PAD0 PORT_SERCOM4_PAD0  /* PC21 TX */
#define BOARD_SERCOM4_PINMAP_PAD1 PORT_SERCOM4_PAD1  /* PC22 RX */
...
#define BOARD_SERCOM4_COREGEN     2          /* GCLK2 = 100 MHz */
#define BOARD_SERCOM4_CORELOCK    FALSE
#define BOARD_SERCOM4_FREQUENCY   BOARD_GCLK2_FREQUENCY

/* SERCOM0 – GPS UART (PC00 PAD0 TX / PC01 PAD1 RX, function D)
 *   ATDF-verified: PC00/PC01 mux D = SERCOM0 PAD0/PAD1
 *   Core clock: GCLK2 = 100 MHz → 9600/57600/115200 baud
 */

#define BOARD_SERCOM0_MUXCONFIG  (USART_CTRLA_TXPO_PAD0 | USART_CTRLA_RXPAD1)
#define BOARD_SERCOM0_PINMAP_PAD0 PORT_SERCOM0_PAD0  /* PC00 TX */
#define BOARD_SERCOM0_PINMAP_PAD1 PORT_SERCOM0_PAD1  /* PC01 RX */
...
#define BOARD_SERCOM0_COREGEN    2          /* GCLK2 = 100 MHz */
#define BOARD_SERCOM0_CORELOCK   FALSE
#define BOARD_SERCOM0_FREQUENCY  BOARD_GCLK2_FREQUENCY
...
/* SERCOM3 – Telemetry 2 UART (PD03 PAD0 TX / PD04 PAD1 RX, function D)
 *   ATDF-verified: PD03/PD04 mux D = SERCOM3 ioset2 PAD0/PAD1
 *   RMII Ethernet does NOT use PD03/PD04 — no conflict.
 *   Core clock: GCLK2 = 100 MHz → supports up to 921600 baud
 */

#define BOARD_SERCOM3_MUXCONFIG  (USART_CTRLA_TXPO_PAD0 | USART_CTRLA_RXPAD1)
#define BOARD_SERCOM3_PINMAP_PAD0 PORT_SERCOM3_PAD0  /* PD03 TX */
#define BOARD_SERCOM3_PINMAP_PAD1 PORT_SERCOM3_PAD1  /* PD04 RX */
...
#define BOARD_SERCOM3_COREGEN    2          /* GCLK2 = 100 MHz */
#define BOARD_SERCOM3_CORELOCK   FALSE
#define BOARD_SERCOM3_FREQUENCY  BOARD_GCLK2_FREQUENCY
...
/* SERCOM7 – RC Input UART (PD14 PAD0 TX / PD15 PAD1 RX, function D)
 *   ATDF-verified: PD14/PD15 mux D = SERCOM7 PAD0/PAD1
 *   Core clock: GCLK2 = 100 MHz → 100000 baud (SBUS) / 420000 baud (CRSF)
 */

#define BOARD_SERCOM7_MUXCONFIG  (USART_CTRLA_TXPO_PAD0 | USART_CTRLA_RXPAD1 | USART_CTRLA_RXINV)
#define BOARD_SERCOM7_PINMAP_PAD0 PORT_SERCOM7_PAD0  /* PD14 TX */
#define BOARD_SERCOM7_PINMAP_PAD1 PORT_SERCOM7_PAD1  /* PD15 RX */
...
#define BOARD_SERCOM7_COREGEN    2          /* GCLK2 = 100 MHz */
#define BOARD_SERCOM7_CORELOCK   FALSE
#define BOARD_SERCOM7_FREQUENCY  BOARD_GCLK2_FREQUENCY
